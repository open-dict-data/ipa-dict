...
* German data provided by [german-ipa-dict] by @devio-at, based on Wiktionary, and released under a [CC BY-SA license](https://github.com/devio-at/german-ipa-dict/blob/main/LICENSE.md).
